          ...
          <div className="contact_details">
            ...
            <div className="contact_details_info">
               <div className='mail_details'>
                ...
                <a className='contacta_tag'  href="mailto:deepakkarki.work@gmail.com"> Send Mail</a>
              </div>
              <div className='Call_details'>
                <p className="Call_icon"><IoMdCall /></p>
               <a className='contacta_tag' href="tel:+9410599517">Call Me</a>
              </div>
              <div className='location_details'>
                <p className="location_icon"><FaLocationDot /></p>
                <a className='contacta_tag' href="https://maps.app.goo.gl/o6RfhxVS1NX7GTWx6" target='blank'>Haldwani, Uttarakhand</a>
              </div>
            ...
            <div className="contactform_location">
              ...
              <div className='location_map'>
                ...
                <iframe
                  ...
                  width="100%" height="180" style={{ border: 0 }} title='map' allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
              </div>


              <div className="Contact_form">
                <form method="POST" action="https://formspree.io/f/mwpeopgb">
